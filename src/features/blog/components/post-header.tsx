...
export const PostHeader = () => {
  ...
  return (
    <header className="bg-surface-section relative overflow-hidden border-b border-green-500/20">
      <ScanlinePlane />
      ...
      <div className="max-w-frame relative z-30 mx-auto px-6 py-8">
        ...
        <div className="grid gap-x-10 gap-y-5 sm:grid-cols-[11rem_minmax(0,1fr)] lg:grid-cols-[16rem_minmax(0,1fr)]">
          <Plate />
