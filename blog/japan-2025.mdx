...
- Hachikō statue
- Searching for manga for my brother, visited a few stores
...
- But didn't find the specific manga he was looking for, so we settled for some crepes from a nearby shop instead called "Dipper Dan"
...
- Came back to say goodbye to the deers and head back to...
