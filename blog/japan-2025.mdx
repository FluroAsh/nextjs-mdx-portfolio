...
Venturing through the busy shopping streets of Ginza, we find the restaraunt just off the main street, tucked underneath some stairs — there was a bit of a queue,
...
After playing in the proverbial bubble bath, we found ourselves in a different universe, this time one filled with cubes bigger than me! The cubes has
blue streams of light flown down them, and would react to you if you got close enough, moving and flowing around you as if you water standing underneath a waterfall. ☂️

{/* "Universe of Water Particles" - https://www.teamlab.art/ew/waterparticles-darkness-azabudai/tokyo/ */}
{/* ![Dark room with large boxes and light projections](https://s3-upload-thing.s3.ap-southeast-2.amazonaws.com/japan-2025/tokyo/day-2/nkon-tokyo-d2-15/large_nkon-tokyo-d2-15.webp) */}
...
{/* Peace can be Realized Even without Order -  https://www.teamlab.art/ew/peace-dissolving-light-azabudai/tokyo/ */}
{/* ![Interactive mist art projection](https://s3-upload-thing.s3.ap-southeast-2.amazonaws.com/japan-2025/tokyo/day-2/nkon-tokyo-d2-12/large_nkon-tokyo-d2-12.webp) */}
...
<iframe
  ...
  width="1249"
  height="703"
  src="https://www.youtube.com/embed/icKMrfu66Ic?list=TLGGqNCI_ZuMeiUyMzA4MjAyNQ"
...
{/* Snake thing before tea time! */}
![Tree & Snake digital art piece projected on the wall](https://s3-upload-thing.s3.ap-southeast-2.amazonaws.com/japan-2025/tokyo/day-2/nkon-tokyo-d2-11/large_nkon-tokyo-d2-11.webp)

{/* -- Immersive Tea Time! (En Tea House) -- */}
![Immersive Tea Time Waiting Room](https://s3-upload-thing.s3.ap-southeast-2.amazonaws.com/japan-2025/tokyo/day-2/nkon-tokyo-d2-16/large_nkon-tokyo-d2-16.webp)

<iframe
  className="aspect-video h-fit max-w-full"
  width="877"
  height="493"
  src="https://www.youtube.com/embed/9UDcm3E8Juc?list=TLGGXwWQamBwpcAyMzA4MjAyNQ"
  title="EN TEA HOUSE Highlight Video"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share;"
  referrerPolicy="strict-origin-when-cross-origin"
  allowFullScreen
/>
...
- Yakitori Torikizoku Hatchobori (Dinner)
  ...
  - Mochi ice-cream (Yuki: Strawberry)
    Said goodbye to our friends who were heading back into Ginza to dno some shopping
- Headed back to Azubadai Hills for a quick coffee top-up
